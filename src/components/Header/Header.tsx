...
const Header = () => {
  return (
    <header className="w-full h-[calc(100vh-96px)] bg-gradient-to-r bg-gradient__header flex justify-center md:items-start items-center">
      <div className="w-2/5 lg:w-4/5 h-4/5 md:h-2/3 bg-septenary rounded-3xl border-[3px] border-black md:mt-5 shadow-secondary-shadow md:shadow-primary-shadow md:shadow-[#53AFB6] shadow-[#53AFB6] pt-8 relative">
        <ResumeDataBox />
